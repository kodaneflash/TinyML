...
from TinyML import Model
from TinyML.internal.common.provider import Provider
from TinyML.internal.data_generation.core.generation.utils.oversampling import oversample_with_smote
from TinyML.internal.data_generation.generator import DataGenerationRequest
from TinyML.internal.models.generators import GenerationResult
...
class TestDataGeneration:
    ...
    def setup_mocks(self):
        ...
        self.mock_generate_data = patch("TinyML.models.generate_data", return_value=pd.DataFrame()).start()

        # Mock the model generation function
        self.mock_generate = patch(
            "TinyML.models.ModelGenerator.generate", return_value=(GenerationResult("", "", MagicMock(), [], None))
        ).start()
